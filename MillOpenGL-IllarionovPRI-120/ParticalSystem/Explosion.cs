...
namespace MillOpenGL_IllarionovPRI_120.ParticalSystem
{
    public class Explosion
    {
        ...
        private void CreateDisplayList()
        {
            ...
            Glut.glutSolidSphere(0.01, 25, 25);
            ...
            if (isStart)
            {
                ...
                for (int ax = 0; ax < _particles_now; ax++)
                {
                    ...
                    if (PartilceArray[ax].isLife())
                    {
                        ...
                        if (PartilceArray[ax].GetPositionY() < -4)
                        {
